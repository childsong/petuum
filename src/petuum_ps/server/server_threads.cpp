...
int32_t ServerThreads::snapshot_clock_;
int32_t ServerThreads::resume_clock_;
std::string ServerThreads::snapshot_dir_;

void ServerThreads::Init(int32_t id_st, int32_t snapshot_clock,
  int32_t resume_clock, const std::string & snapshot_dir){
...
void ServerThreads::InitServer(int32_t my_id) {
  ...
  server_context_->server_obj_.Init(snapshot_dir_, snapshot_clock_,
    my_id, resume_clock_);
