...
num_app_threads_per_node = 1
num_bg_threads_per_node = 1
server_id_offset = num_app_threads_per_node + num_bg_threads_per_node
...
if __name__ == '__main__':
    ...
    num_app_threads_per_node = int(sys.argv[3])
    ...
    print "Number app threads per node: %d" % num_app_threads_per_node
    print "Number bg threads per node: %d" % num_bg_threads_per_node
